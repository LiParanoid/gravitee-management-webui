...
class EnvironmentService {
  ...
  getPermissions(envId: string, envHrid: string): ng.IPromise<IHttpResponse<Record<string, string[]>>> {
    return this.$http.get(`${this.environmentsURL}/permissions?id=${envId}&hrid=${envHrid}`);
  }
